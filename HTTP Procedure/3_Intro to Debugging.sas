/************************************************************************************************
   PROC HTTP - INTRO TO DEBUGGING
   This program demonstrates basic debuggin techniques for PROC HTTP 
    Primary Syntax: PROC HTTP
    SAS Versions: SAS 9, SAS Viya
    Documentation: https://go.documentation.sas.com/doc/en/pgmsascdc/default/proc/n0i2ek87s12e7mn1h2q3h0mywkl1.htm
************************************************************************************************/
/************************************************************************************************
